 ...
 *
 * @param {import("./syntax-node.js").SyntaxNode} node
 * @returns {void}
 */
 ...
 *
 * @param {import("./syntax-node.js").SyntaxNode} parent
 ...
 * @param {(markdown: string) => import("./syntax-node.js").SyntaxNode} parseFn
 ...
 *
 * @param {import("./syntax-tree.js").SyntaxTree} tree
 * @param {import("./syntax-node.js").SyntaxNode} refNode
 * @param {import("./syntax-node.js").SyntaxNode[]} newNodes
 * @returns {{ renderHints: { updated: string[], added: string[], removed: string[] }, selection: any }}
 */
 ...
 *
 * @param {import("./syntax-node.js").SyntaxNode} list — a node with type "list"
 ...
 *
 * @param {import("./syntax-node.js").SyntaxNode} node — the node being edited
 * @param {string} newContent — the new content for the node (without prefix)
 * @param {(text: string) => import("./syntax-node.js").SyntaxNode | null} parseFn
