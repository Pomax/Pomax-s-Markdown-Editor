...
import { rebuildInlineChildren, mergeHints } from '../../src/syntax-tree/tree-mutations.js';
...
describe(`mergeHints`, () => {
  it(`merges two empty hints`, () => {
    ...
    assert.deepStrictEqual(result.renderHints, {
      updated: [],
      added: [],
      removed: [],
    });
  ...
  it(`unions updated arrays`, () => {
    const a = {
      renderHints: { updated: [`a`, `b`], added: [], removed: [] },
      selection: null,
    };
    const b = {
      renderHints: { updated: [`b`, `c`], added: [], removed: [] },
      selection: null,
    };
    const result = mergeHints(a, b);
  ...
  it(`unions added arrays`, () => {
    const a = {
      renderHints: { updated: [], added: [`x`], removed: [] },
      selection: null,
    };
    const b = {
      renderHints: { updated: [], added: [`y`], removed: [] },
      selection: null,
    };
    const result = mergeHints(a, b);
  ...
  it(`unions removed arrays`, () => {
    const a = {
      renderHints: { updated: [], added: [], removed: [`d1`] },
      selection: null,
    };
    const b = {
      renderHints: { updated: [], added: [], removed: [`d2`] },
      selection: null,
    };
    const result = mergeHints(a, b);
  ...
  it(`deduplicates ids across all hint arrays`, () => {
    const a = {
      renderHints: { updated: [`x`], added: [`x`, `y`], removed: [`z`] },
      selection: null,
    };
    const b = {
      renderHints: { updated: [`x`], added: [`y`], removed: [`z`, `w`] },
      selection: null,
    };
    const result = mergeHints(a, b);
  ...
  it(`selection from b wins`, () => {
    const a = {
      renderHints: { updated: [], added: [], removed: [] },
      selection: { nodeId: `a`, offset: 5 },
    };
    const b = {
      renderHints: { updated: [], added: [], removed: [] },
      selection: { nodeId: `b`, offset: 3 },
    };
    const result = mergeHints(a, b);
