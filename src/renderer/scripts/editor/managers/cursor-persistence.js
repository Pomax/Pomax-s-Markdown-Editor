 ...
 * @param {(type: string, content: string, attrs: import('../../../../../old-parser/parser/syntax-tree.js').NodeAttributes) => string} buildMarkdownLine
 * @param {(type: string, attrs?: import('../../../../../old-parser/parser/syntax-tree.js').NodeAttributes) => number} getPrefixLength
