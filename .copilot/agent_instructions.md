- Only ever use Opus 4.5 or newer. Do not use any other models.
- When VS Code spawns a new terminal, always run `cmd` first to force it back to the proper command prompt.
