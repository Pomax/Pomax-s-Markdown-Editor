...
describe("@tooling/syntax-tree exports", () => {
  ...
  // Re-exported parser utilities
  it("exports parseInlineContent", () => {
    assert.strictEqual(typeof parseInlineContent, "function");
  });
  it("exports tokenizeInline", () => {
    assert.strictEqual(typeof tokenizeInline, "function");
  });
  it("exports findMatchedTokenIndices", () => {
    assert.strictEqual(typeof findMatchedTokenIndices, "function");
  });
});

// ── @tooling/parser exports ─────────────────────────────────────────

import {
  parse,
  parseLine,
  findMatchedTokenIndices as parserFMTI,
  tokenizeInline as parserTI,
} from "../../parser/index.js";

describe("@tooling/parser exports", () => {
  it("exports parse (async)", () => {
    assert.strictEqual(typeof parse, "function");
  });
  it("exports parseLine", () => {
    assert.strictEqual(typeof parseLine, "function");
  });
  it("exports findMatchedTokenIndices", () => {
    assert.strictEqual(typeof parserFMTI, "function");
  });
  it("exports tokenizeInline", () => {
    assert.strictEqual(typeof parserTI, "function");
  });
});
